...
test("deno-basic template ships a runtime-native scaffold", async () => {
  ...
  assert.equal(denoJson.imports["@daloyjs/core"], "jsr:@daloyjs/daloy@^0.39.1");
  assert.equal(
    denoJson.imports["@daloyjs/core/deno"],
    "jsr:@daloyjs/daloy@^0.39.1/deno",
  );
  assert.equal(
    denoJson.imports["@daloyjs/core/banner"],
    "jsr:@daloyjs/daloy@^0.39.1/banner",
  );
  assert.equal(
    denoJson.imports["@daloyjs/core/openapi"],
    "jsr:@daloyjs/daloy@^0.39.1/openapi",
  );
});
